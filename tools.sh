#!/bin/bash
# Hacking Tools Collection by Vaibhav Pathak
# Website : http://vaibhavpathakofficial.tk/
# Facebook Page : https://www.facebook.com/vaibhavdevpp
...
cat  <<  EOF 
   ...
   ____         U  ___ u      _   _          _            ____        _  __    
U /"___|u        \/"_ \/     |'| |'|     U  /"\  u     U /"___|      |"|/ /    
\| |  _ /        | | | |    /| |_| |\     \/ _ \/      \| | u        | ' /     
 | |_| |     .-,_| |_| |    U|  _  |u     / ___ \       | |/__     U/| . \\u   
